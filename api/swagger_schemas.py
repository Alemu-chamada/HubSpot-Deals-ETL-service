"""
Swagger/OpenAPI schema definitions for HubSpot Deals Extraction API
"""
...
def register_models(api: Api):
    ...
    filters_model = api.model('Filters', {
        'properties': fields.List(
            fields.String,
            description='Deal properties to extract',
            example=['dealname', 'amount', 'pipeline', 'dealstage', 'closedate']
        ),
    ...
    scan_config_model = api.model('ScanConfig', {
        'scanId': fields.String(
            ...
            example='hubspot-deals-scan-2025-001'
        ),
        ...
        'type': fields.List(
            fields.String, 
            required=True,
            description='Type of scan (must be "deals")',
            example=['deals']
        ),
    ...
    # Deal property model
    deal_property_model = api.model('DealProperty', {
    ...
    # Deal properties model
    deal_properties_model = api.model('DealProperties', {
        'standard': fields.List(fields.Nested(deal_property_model)),
    ...
    tables_response_model = api.model('TablesResponse', {
        'scanId': fields.String(description='Scan identifier'),
        'datasetName': fields.String(description='DLT dataset (PostgreSQL schema) name'),
    ...
    pipeline_info_model = api.model('PipelineInfo', {
        ...
        'database_health': fields.Raw(description='Database health status details'),
    ...
    return {
        ...
        'deal_property_model': deal_property_model,
        'deal_properties_model': deal_properties_model,
