...
class Config:
    ...
    APP_TITLE = os.environ.get('APP_TITLE', 'HubSpot Deals ETL Service')
    APP_DESCRIPTION = os.environ.get('APP_DESCRIPTION', 'Service for extracting HubSpot Deals and storing them in PostgreSQL')
    ...
    ENCRYPTION_PASSWORD = os.environ.get('CONFIG_PASSWORD', 'replace-with-encryption-password')
    ...
    # Database settings for PostgreSQL destination
    DB_HOST = os.environ.get('DB_HOST', 'replace-with-db-host')
    DB_PORT = int(os.environ.get('DB_PORT', 5432))
    DB_NAME = os.environ.get('DB_NAME', 'replace-with-db-name')
    DB_USER = os.environ.get('DB_USER', 'replace-with-db-user')
    DB_PASSWORD = os.environ.get('DB_PASSWORD', 'replace-with-db-password')
    DB_SCHEMA = os.environ.get('DB_SCHEMA', 'hubspot')
    ...
    DLT_PIPELINE_NAME = os.environ.get('DLT_PIPELINE_NAME', 'hubspot_deals_etl')
    DLT_WORKING_DIR = os.environ.get('DLT_WORKING_DIR', '.dlt')
    DLT_RUNTIME_ENV = os.environ.get('DLT_RUNTIME_ENV', 'development')
    
    # HubSpot settings
    HUBSPOT_PRIVATE_APP_ACCESS_TOKEN = os.environ.get('HUBSPOT_PRIVATE_APP_ACCESS_TOKEN', os.environ.get('HUBSPOT_ACCESS_TOKEN', 'replace-with-your-private-app-token'))
    HUBSPOT_API_BASE_URL = os.environ.get('HUBSPOT_API_BASE_URL', os.environ.get('API_BASE_URL', 'https://api.hubapi.com'))
    HUBSPOT_API_TIMEOUT = int(os.environ.get('HUBSPOT_API_TIMEOUT', os.environ.get('API_TIMEOUT', 30)))
    
    # External API settings
    API_BASE_URL = HUBSPOT_API_BASE_URL
    API_TIMEOUT = HUBSPOT_API_TIMEOUT
    ...
    PAGINATION_DEFAULT_LIMIT = int(os.environ.get('PAGINATION_DEFAULT_LIMIT', 50))
    ...
    def get_extraction_config(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            'pagination_default_limit': cls.PAGINATION_DEFAULT_LIMIT,
            
            # HubSpot configuration
            'hubspot_private_app_access_token': cls.HUBSPOT_PRIVATE_APP_ACCESS_TOKEN,
    ...
    def get_api_config(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            "default_results_limit": cls.PAGINATION_DEFAULT_LIMIT,    # Default number of results per page            
...
class ProductionConfig(Config):
    ...
    def validate_production_config(cls):
        ...
        required_vars = ['SECRET_KEY', 'DB_PASSWORD', 'HUBSPOT_PRIVATE_APP_ACCESS_TOKEN']
